...
Adaptive_filter_sum_array_max_in_cycle 	            = cast(zeros(sim_options.Size_matrix*sim_options.Size_matrix,sim_options.Size_matrix,sim_options.M-1), sim_options.type_add_in_adaptive_filter);
Adaptive_filter_sum_total_width_in_cycle 	        = cast(zeros(sim_options.Size_matrix*sim_options.Size_matrix,sim_options.Size_matrix,sim_options.M-1), sim_options.type_add_in_adaptive_filter);
...
for num = 1:sim_options.num_cycles
   ...
   load ('2025             12              5             17             32          4.954.mat'); % 888 MHz 70 SNR
...
% % Записываем значения каждого фильтра
    ...
    for i = 1:sim_options.M-1
		...
		for k = 1:sim_options.Size_matrix
            for t = 1:sim_options.Size_matrix
...
if sim_options.enable_mask == false
    ...
    %     end
        ...
        Sum4_adaptive = Adaptive_filter_sum_array_max_in_cycle(:,4,i);
        Sum5_adaptive = Adaptive_filter_sum_array_max_in_cycle(:,5,i);

        % формируем таблицу адаптивного фильтра
        T8 = table(Multipliers_adaptive, Sum1_adaptive, Sum2_adaptive, Sum3_adaptive, Sum4_adaptive, Sum5_adaptive, 'RowNames', num_adaptive);
        ...
        Sum4_adaptive_total_width = Adaptive_filter_sum_total_width_in_cycle(:,4,i);
        Sum5_adaptive_total_width = Adaptive_filter_sum_total_width_in_cycle(:,5,i);

        % формируем таблицу адаптивного фильтра
        T9 = table(Multipliers_adaptive_total_width, Sum1_adaptive_total_width, Sum2_adaptive_total_width, Sum3_adaptive_total_width, Sum4_adaptive_total_width, ...
            Sum5_adaptive_total_width, 'RowNames', num_adaptive);
