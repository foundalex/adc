function [yri, ymi, y_fractional_outInt, ymi_HilbertInt, fractional_mult, fractional_sum, hilbert_mult, hilbert_sum] = fractional_delays(input_signal, hri_w, hh_m, coeff_frac_int, ...
    fractional_width, hilbert_coeff_int, sim_options)
        ...
        % N = 18 - 13 = 5;
        [y_fractional_outInt, fractional_mult, fractional_sum] = fir_filter(coeff_frac_int, input_signal, 'int32', 32, ...
            0, 'Width multiplier Fractional filter.txt', 'Width adder Fractional filter.txt'); % (стр.6 (15)) 
