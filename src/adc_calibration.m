...
function [sig_adc, x_after_adc, x_after_adc_int, error_det, error_det_lu] = adc_calibration(sim_options, adc_input, adc_input_int, s_to_subadc, s_after_subadc)
    ...
    [y_array, y_array_int, error_out, error_det, error_det_lu] = least_mean_squares(adc_input, adc_input_int, yri_cut, yri_cut_int, sim_options.M, 5);
