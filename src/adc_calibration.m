...
function [x_after_adc, x_after_adc_int, fractional_mult, fractional_sum, fractional_width_total_mult, fractional_width_total_sum, ...  
    ...
    for i = 1:sim_options.M-1
        ...
        ymi_HilbertInt_double = double(ymi_HilbertInt)*2^-(sim_options.hilbert_coeff_width-1 + sim_options.fractional_coeff_width-1);
        relative_error_hilbert = ymi./ymi_HilbertInt_double;

        snr_hilbert_out_double = snr(ymi, 1000000000);
        snr_hilbert_out_int = snr(double(ymi_HilbertInt)*2^-(sim_options.hilbert_coeff_width-1 + sim_options.fractional_coeff_width-1), 1000000000);
        ...
        figure(5);
        subplot(4,1,1)
        plot([ymi(1:500), double(ymi_HilbertInt(1:500))*2^-(sim_options.hilbert_coeff_width-1 + sim_options.fractional_coeff_width-1)]);
        subplot(4,1,2);
        snr(ymi, 1000000000);
        subplot(4,1,3);
        snr(double(ymi_HilbertInt)*2^-(sim_options.hilbert_coeff_width-1 + sim_options.fractional_coeff_width-1), 1000000000);
        subplot(4,1,4);
