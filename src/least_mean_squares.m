...
x3_int = cast(zeros(sim_options.Size_matrix,sim_options.Size_matrix), "int64"); 
...
% 
% [det_x3(tt), det_x3_int(tt), Det_5x5_LU_matlab_array(tt), DetM_2x2, DetM_2x2_int, Det_2x2_LU_matlab, DetM_3x3_array, Det_3x3_LU_matlab, DetM_4x4_array, Det_4x4_LU_matlab, ...   
% 	... % умножители определителя 2x2 
...
% ] = determinate(x3, x3_int, sim_options);
% 
% DetM_2x2_array_int(1:10) = DetM_2x2_int;
% DetM_2x2_array(1:10) = DetM_2x2;
% Det_2x2_LU_matlab_array(1:10) = Det_2x2_LU_matlab;
% %%
% DetM_3x3_array_int(1:10) = DetM_3x3_int_sum_array;
% DetM_3x3_array_dd(1:10) = DetM_3x3_array;
% Det_3x3_LU_matlab_array(1:10) = Det_3x3_LU_matlab;
% % %%
% DetM_4x4_array_int(1:5) = DetM_4x4_int_sum_array;
% DetM_4x4_array_dd(1:5) = DetM_4x4_array;
% Det_4x4_LU_matlab_array(1:5) = Det_4x4_LU_matlab;
% 
% % Det_5x5_LU_matlab_array(tt) = Det_5x5_LU_matlab;
% 
% bb = bb + 10;
% vv = vv + 5;
...
% 
%     [det_out_shift(kk), det_out_shift_int(kk), Det_5x5_LU_matlab_array(tt), DetM_2x2, DetM_2x2_int, Det_2x2_LU_matlab, DetM_3x3_array, Det_3x3_LU_matlab, DetM_4x4_array, Det_4x4_LU_matlab, ....   
% 		... % умножители определителя 2x2 
% 		DetM_2x2_multiplier_total_abs, ...
% 		... % сумматоры определителя 2x2 
% 		Det2x2_sum_abs, ...
...
% 
%     % Det_5x5_LU_matlab_array(kk+1) = Det_5x5_LU_matlab;
% 
%     bb = bb + 10;
% 	vv = vv + 5;
% 
...
% 
% 	%% divide determinant
% 	% www1(:,i) = Det_5x5_LU_matlab_array(tt) / Det_5x5_LU_matlab_array(tt-(tt-1)); % double
% 	% www1_int(:,i) = divide(det_x3_int(tt), det_x3_int(tt-(tt-1)), 14); % integer
% 
...
%     y_outd = y_outd + www1(i) * adc_input(i); % (стр 5, (13))
%     dat_in_filt_double(i) = adc_input(i);
%     dat_in_filt(i) = cast(adc_input_int(i),"double");
% % end
% end
...
w1 = lsqminnorm(x3, yri_cut(1:sim_options.Size_matrix));
%% filter
...
for j = 1:length(yri_cut(:,1))-2*sim_options.Size_matrix
    ...
    for i = 1:sim_options.Size_matrix
        if j == 1
            ...
            x3_int(i,sim_options.Size_matrix) = adc_input_int(j-1+sim_options.Size_matrix-1+i); 
        end
	end
	...
	for i = 1:sim_options.Size_matrix
		...
		% 
		%    DetM_3x3_int_double = [cast(DetM_3x3_int_sum_array(1:4),int_size_single); cast(DetM_3x3_int_sum_array(5:10),int_size_single)*2^-remainder];
		% 
		%    DetM_4x4_int_double = [cast(DetM_4x4_int_sum_array(1),int_size_single); cast(DetM_4x4_int_sum_array(2:5),int_size_single)*2^-remainder];
		% elseif i == 2
		%    DetM_2x2_int_double = [cast(DetM_2x2_int(1),int_size_double)*2^-remainder; cast(DetM_2x2_int(2:4),int_size_double); cast(DetM_2x2_int(5:7),int_size_double)*2^-remainder; cast(DetM_2x2_int(8:10),int_size_double)];
		%    DetM_2x2_double = [(DetM_2x2(1))*2^-remainder; (DetM_2x2(2:4)); (DetM_2x2(5:7))*2^-remainder; (DetM_2x2(8:10))];
		% 
		%    DetM_3x3_int_double = [cast(DetM_3x3_int_sum_array(1),int_size_single); cast(DetM_3x3_int_sum_array(2:4),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(5:7),int_size_single); cast(DetM_3x3_int_sum_array(8:10),int_size_single)*2^-remainder];
		% 
		%    DetM_4x4_int_double = [cast(DetM_4x4_int_sum_array(1),int_size_single)*2^-remainder; cast(DetM_4x4_int_sum_array(2),int_size_single); cast(DetM_4x4_int_sum_array(3:5),int_size_single)*2^-remainder];
		% elseif i == 3
		%    DetM_2x2_int_double = [cast(DetM_2x2_int(1),int_size_double); cast(DetM_2x2_int(2),int_size_double)*2^-remainder; cast(DetM_2x2_int(3:4),int_size_double); cast(DetM_2x2_int(5),int_size_double)*2^-remainder; cast(DetM_2x2_int(6:7),int_size_double); ...
		%    cast(DetM_2x2_int(8:9),int_size_double)*2^-remainder; cast(DetM_2x2_int(10),int_size_double)];
		% 
		%    DetM_2x2_double = [(DetM_2x2(1)); (DetM_2x2(2))*2^-remainder; (DetM_2x2(3:4)); (DetM_2x2(5))*2^-remainder; (DetM_2x2(6:7)); ...
		%    double(DetM_2x2(8:9))*2^-remainder; (DetM_2x2(10))]; 
		% 
		%    DetM_3x3_int_double = [cast(DetM_3x3_int_sum_array(1),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(2),int_size_single); cast(DetM_3x3_int_sum_array(3:4),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(5),int_size_single); 
		%        cast(DetM_3x3_int_sum_array(6:7),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(8:9),int_size_single); cast(DetM_3x3_int_sum_array(10),int_size_single)*2^-remainder];
		% 
		%    DetM_4x4_int_double = [cast(DetM_4x4_int_sum_array(1:2),int_size_single)*2^-remainder; cast(DetM_4x4_int_sum_array(3),int_size_single); cast(DetM_4x4_int_sum_array(4:5),int_size_single)*2^-remainder];
		% elseif i == 4
		%    DetM_2x2_int_double = [cast(DetM_2x2_int(1:2),int_size_double); cast(DetM_2x2_int(3),int_size_double)*2^-remainder; cast(DetM_2x2_int(4:5),int_size_double); cast(DetM_2x2_int(6),int_size_double)*2^-remainder; cast(DetM_2x2_int(7),int_size_double); ...
		%    cast(DetM_2x2_int(8),int_size_double)*2^-remainder; cast(DetM_2x2_int(9),int_size_double); cast(DetM_2x2_int(10),int_size_double)*2^-remainder];
		% 
		...
		% 
		%    DetM_3x3_int_double = [cast(DetM_3x3_int_sum_array(1:2),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(3),int_size_single); cast(DetM_3x3_int_sum_array(4:5),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(6),int_size_single); cast(DetM_3x3_int_sum_array(7),int_size_single)*2^-remainder; ...
		%    cast(DetM_3x3_int_sum_array(8),int_size_single); cast(DetM_3x3_int_sum_array(9),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(10),int_size_single)];
		% 
		%    DetM_4x4_int_double = [cast(DetM_4x4_int_sum_array(1:3),int_size_single)*2^-remainder; cast(DetM_4x4_int_sum_array(4),int_size_single); cast(DetM_4x4_int_sum_array(5),int_size_single)*2^-remainder];
		% elseif i == 5
		%    DetM_2x2_int_double = [cast(DetM_2x2_int(1:3),int_size_double); cast(DetM_2x2_int(4),int_size_double)*2^-remainder; cast(DetM_2x2_int(5:6),int_size_double); cast(DetM_2x2_int(7),int_size_double)*2^-remainder; cast(DetM_2x2_int(8),int_size_double); ...
		%    cast(DetM_2x2_int(9:10),int_size_double)*2^-remainder];
		% 
		...
		% 
		%    DetM_3x3_int_double = [cast(DetM_3x3_int_sum_array(1:3),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(4),int_size_single); cast(DetM_3x3_int_sum_array(5:6),int_size_single)*2^-remainder; cast(DetM_3x3_int_sum_array(7),int_size_single); cast(DetM_3x3_int_sum_array(8),int_size_single)*2^-remainder; ...
		%    cast(DetM_3x3_int_sum_array(9:10),int_size_single)];
		% 
